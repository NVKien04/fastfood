...
export class AddComboTables1785163173069 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "combo_items" ADD CONSTRAINT "FK_3b4ce71c9b99bd8b26ce0618408" FOREIGN KEY ("comboId") REFERENCES "combos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order-items" ADD CONSTRAINT "FK_5515619939efb4df8d893693e94" FOREIGN KEY ("comboId") REFERENCES "combos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cart_items" ADD CONSTRAINT "FK_cae9ea0b56adddcafc6561f3db4" FOREIGN KEY ("comboId") REFERENCES "combos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
