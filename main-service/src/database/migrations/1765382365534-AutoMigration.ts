...
export class AutoMigration1765382365534 implements MigrationInterface {
    name = 'AutoMigration1765382365534'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product" ADD "basePrice" character varying NOT NULL`);
