...
import { IProductIngredientRepository } from './productIngredient.repository.interface';
import { ProductIngredientsEntity } from '#src/entities/product_ingredients';
@Injectable()
export class ProductIngredientRepository
  extends BaseRepository<ProductIngredientsEntity>
  implements IProductIngredientRepository
{
  constructor(
    @InjectRepository(ProductIngredientsEntity)
    repo: Repository<ProductIngredientsEntity>,
