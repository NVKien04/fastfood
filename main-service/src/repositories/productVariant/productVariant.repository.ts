...
import { IProductVariantRepository } from './productVariant.repository.interface';
import { ProductVariantsEntity } from '#src/entities/product_variants';

@Injectable()
export class ProductVariantRepository
  extends BaseRepository<ProductVariantsEntity>
  implements IProductVariantRepository
{
  constructor(
    @InjectRepository(ProductVariantsEntity)
    repo: Repository<ProductVariantsEntity>,
