  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="relative group">
        <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden border-4 border-white shadow-xl shadow-gray-200/50 bg-gray-100 flex items-center justify-center relative">
          {activeAvatarUrl ? (
            <img
              src={activeAvatarUrl}
              alt={userName}
        ...
        <button
          ...
          className="absolute bottom-0 right-0 p-2 rounded-full bg-red-600 hover:bg-red-700 text-white shadow-md transition-transform active:scale-95 disabled:opacity-50"
        ...
        <div className="flex flex-col items-center gap-2 animate-in fade-in zoom-in-95 duration-150">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="h-8 px-3 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-bold shadow-sm"
            >
            ...
            <Button
              ...
              className="h-8 px-3 rounded-xl text-xs font-semibold text-gray-600 hover:bg-gray-100"
            >
              Hủy
            </Button>
          </div>
      ...
      {!selectedFile && activeAvatarUrl && (
        <button
          ...
          className="text-xs text-gray-400 hover:text-red-600 transition-colors flex items-center gap-1 font-medium disabled:opacity-50"
        >
